      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-800/80 rounded-xl border-2 border-yellow-500/50 p-5">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg mb-3 text-xs font-medium ${
              ...
              <span>{diagnosis.rebalanceUrgency === 'high' ? '🚨' : diagnosis.rebalanceUrgency === 'medium' ? '⚠️' : '✅'}</span>
              <span>{diagnosis.rebalanceNote}</span>
            </div>
